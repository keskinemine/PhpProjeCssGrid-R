...
$toplamKayitSayisiSorgusu               =   $baglanti->prepare("SELECT * FROM urunler WHERE urunTuru = 'Erkek Ayakkabısı' AND Durumu = '1' $menuKosulu $aramaKosulu ORDER BY id DESC");
$toplamKayitSayisiSorgusu->execute();
$toplamKayitSayisiSorgusu               =   $toplamKayitSayisiSorgusu->rowCount();
$sayfalamayaBaslanacakKayitSayisi       =   ($sayfalama*$sayfaBasinaGosterilecekKayitSayisi)-$sayfaBasinaGosterilecekKayitSayisi;
$bulunanSayfaSayisi                     =   ceil($toplamKayitSayisiSorgusu/$sayfaBasinaGosterilecekKayitSayisi);

$anaMenununTumUrunSayiSorgusu           =   $baglanti->prepare("SELECT SUM(urunSayisi) AS menununToplamUrunu FROM menuler WHERE urunTuru = 'Erkek Ayakkabısı'");
...
<div class="ayakkabilarcon">
    <div class="ayakkabilarsol">
        <div class="ayakkabilarsolmenuler">
            <h4>MENÜLER</h4>
            <p><a href="index.php?sk=84" style="<?php if($gelenmenuId=="") { ?> color: #FF9900;<?php } else{ ?>color: #646464; <?php } ?>">Tüm Ürünler (<?php echo $anaMenununTumUrunSayiSorgusu["menununToplamUrunu"]; ?>)</a></p>
            <?php
            $menulerSorgusu          =   $baglanti->prepare("SELECT * FROM menuler WHERE urunTuru =  'Erkek Ayakkabısı' ORDER BY menuAdi ASC");
            ...
            <p><a href="index.php?sk=84&menuId=<?php echo $menu["id"]; ?>" style="<?php if($gelenmenuId==$menu["id"]) { ?> color: #FF9900;<?php } else{ ?>color: #646464; <?php } ?>"><?php echo donusumleriGeriDondur($menu["menuAdi"]); ?> (<?php echo donusumleriGeriDondur($menu["urunSayisi"]); ?>)</a></p>
    ...
    <div class="ayakkabilarsag">
        ...
        <div class="ayakkabiresimbilgicontainer">
            ...
            <?php
            $urunlerSorgusu    =  $baglanti->prepare("SELECT * FROM urunler WHERE urunTuru = 'Erkek Ayakkabısı' AND Durumu = '1' $menuKosulu $aramaKosulu ORDER BY id DESC LIMIT $sayfalamayaBaslanacakKayitSayisi, $sayfaBasinaGosterilecekKayitSayisi");
            ...
            ?>
                <div class="ayakkabiresimbilgiblog">
                    <table>
                        <tr>
                            <th><a href="index.php?sk=82&id=<?php echo donusumleriGeriDondur($kayit['id']); ?>"><img class="ayakkabiresimbilgiresim" src="resimler/urunResimleri/erkek/<?php echo donusumleriGeriDondur($kayit["urunResmiBir"]); ?>"></a></th>
                        </tr>
                        <tr class="ayakkabiresimbilgisatir">
                            <td><a href="index.php?sk=82&id=<?php echo donusumleriGeriDondur($kayit['id']); ?>" class="ayakkabiresimbilgisatirurunTuru">Erkek Ayakkabısı</a></td>
                        </tr>
                        <tr>
