...
$toplamKayitSayisiSorgusu               =   $baglanti->prepare("SELECT * FROM urunler WHERE urunTuru = 'Çocuk Ayakkabısı' AND Durumu = '1' $menuKosulu $aramaKosulu ORDER BY id DESC");
$toplamKayitSayisiSorgusu->execute();
$toplamKayitSayisiSorgusu               =   $toplamKayitSayisiSorgusu->rowCount();
$sayfalamayaBaslanacakKayitSayisi       =   ($sayfalama*$sayfaBasinaGosterilecekKayitSayisi)-$sayfaBasinaGosterilecekKayitSayisi;
$bulunanSayfaSayisi                     =   ceil($toplamKayitSayisiSorgusu/$sayfaBasinaGosterilecekKayitSayisi);

$anaMenununTumUrunSayiSorgusu           =   $baglanti->prepare("SELECT SUM(urunSayisi) AS menununToplamUrunu FROM menuler WHERE urunTuru = 'Çocuk Ayakkabısı'");
...
<div class="ayakkabilarcon">
    <div class="ayakkabilarsol">
        <div class="ayakkabilarsolmenuler">
            <h4>MENÜLER</h4>
            <p><a href="index.php?sk=86" style="<?php if($gelenmenuId=="") { ?> color: #FF9900;<?php } else{ ?>color: #646464; <?php } ?>">Tüm Ürünler (<?php echo $anaMenununTumUrunSayiSorgusu["menununToplamUrunu"]; ?>)</a></p>
            <?php
            $menulerSorgusu          =   $baglanti->prepare("SELECT * FROM menuler WHERE urunTuru =  'Çocuk Ayakkabısı' ORDER BY menuAdi ASC");
            ...
            <p><a href="index.php?sk=86&menuId=<?php echo $menu["id"]; ?>" style="<?php if($gelenmenuId==$menu["id"]) { ?> color: #FF9900;<?php } else{ ?>color: #646464; <?php } ?>"><?php echo donusumleriGeriDondur($menu["menuAdi"]); ?> (<?php echo donusumleriGeriDondur($menu["urunSayisi"]); ?>)</a></p>
    ...
    <div class="ayakkabilarsag">
        ...
        <div class="ayakkabiresimbilgicontainer">
            ...
            <?php
            $urunlerSorgusu    =  $baglanti->prepare("SELECT * FROM urunler WHERE urunTuru = 'Çocuk Ayakkabısı' AND Durumu = '1' $menuKosulu $aramaKosulu ORDER BY id DESC LIMIT $sayfalamayaBaslanacakKayitSayisi, $sayfaBasinaGosterilecekKayitSayisi");
            ...
            ?>
                <div class="ayakkabiresimbilgiblog">
                    <table>
                        <tr>
                            <th><a href="index.php?sk=82&id=<?php echo donusumleriGeriDondur($kayit['id']); ?>"><img class="ayakkabiresimbilgiresim" src="resimler/urunResimleri/cocuk/<?php echo donusumleriGeriDondur($kayit["urunResmiBir"]); ?>"></a></th>
                        </tr>
                        <tr class="ayakkabiresimbilgisatir">
                            <td><a href="index.php?sk=82&id=<?php echo donusumleriGeriDondur($kayit['id']); ?>" class="ayakkabiresimbilgisatirurunTuru">Çocuk Ayakkabısı</a></td>
                        </tr>
                        <tr>
            ...
            <div class="sayfalamaAlaniKapsayicisi">
                ...
                <div class="sayfalamaAlaniIciNumaraAlaniKapsayicisi">
                    ...
                    if($sayfalama>1){
                        ...
                        echo "<span class='sayfalamaPasif'><a href='index.php?sk=86" .$sayfalamaKosulu . "&syf=" . $sayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
                    }
                    ...
                    for($sayfalamaIcinSayfaIndexDegeri = $sayfalama-$sayfalamaIcinSolveSagButonSayisi; $sayfalamaIcinSayfaIndexDegeri<=$sayfalama+$sayfalamaIcinSolveSagButonSayisi; $sayfalamaIcinSayfaIndexDegeri++){
                        if(($sayfalamaIcinSayfaIndexDegeri>0) and ($sayfalamaIcinSayfaIndexDegeri<=$bulunanSayfaSayisi)){
                            if($sayfalama==$sayfalamaIcinSayfaIndexDegeri){
                                ...
                                echo "<span class='sayfalamaPasif'><a href='index.php?sk=86" .$sayfalamaKosulu . "&syf=" . $sayfalamaIcinSayfaIndexDegeri .  "'> " . $sayfalamaIcinSayfaIndexDegeri . "</a></span>";
                            }
                        }
                    }
                    ...
                    if($sayfalama!=$bulunanSayfaSayisi){
                        ...
                        echo "<span class='sayfalamaPasif'><a href='index.php?sk=86" .$sayfalamaKosulu . "&syf=" . $sayfalamaIcinSayfaDegeriniBirIleriAl .  "'>></a></span>";
